...
utils.plot_by_frequency(df, carb_key, title="Daily CHO", x_axis_label="Daily CHO (g)", bins=15, should_export=True, x_lim=[0, 500])
utils.plot_by_frequency(df, log_carb_key, title="Log Daily CHO", x_axis_label="Log Daily CHO (g)", bins=30, should_export=True, x_lim=[0, 7])
...
utils.plot_by_frequency(df.dropna(subset=[bmi_key]), bmi_key, title="BMI", x_axis_label="BMI", bins=30, should_export=True, x_lim=[0, 50])
...
utils.plot_by_frequency(df, isf_key, title="ISF", x_axis_label="ISF (mg/dL/U)", bins=15, should_export=True, x_lim=[0, 500])
utils.plot_by_frequency(df, log_isf_key, title="Log ISF", x_axis_label="Log ISF (mg/dL/U)", bins=15, should_export=True, x_lim=[0, 7])
...
utils.plot_by_frequency(df, icr_key, title="ICR", x_axis_label="ICR (g/U)", bins=15, should_export=True, x_lim=[0, 55])
utils.plot_by_frequency(df, log_icr_key, title="Log ICR", x_axis_label="Log ICR (g/U)", bins=15, should_export=True, x_lim=[0, 4])
